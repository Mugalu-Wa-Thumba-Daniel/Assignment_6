public class Estate extends Car {
    ...
    public Estate(double CIF_Value, int seating_Capacity, double gross_Weight, double engine_Capacity,int age, String transportation_Mode, String plate_System, int storage_Days) {
    ...
    public double Compute_Taxes() {
        // Calcul des taxes pour les voitures Estate
        double taxes = 0;
        ...
        if (Seating_Capacity > 5){           // If the vehicle has a sitting capacity of more than 5 seats += 250,000 UGX / seats
            taxes += ((Seating_Capacity - 5) * 250000);
        }

        if (Gross_Weight < 1500){            // If the vehicle has a gross weight less than 1500, between 1500 to 2000 and above 2000 tons, ...
            taxes += CIF * 0.02;
        ...
        if (Engine_Capacity <= 1800){        // If the vehicle has an engine capacity of less than 1800 & more than 1800 CC ...
            taxes += CIF * 0.025;
